  ...
  <main>
      ...
      <div class="search-container">
        <div class="container">
          ...
          <ul class="list-items">
            <li
              class="item"
              v-for="value of fabricTypes.filter((i) => !i.disabled)"
              :key="value.label"
            >
              <input
                type="checkbox"
    ...
    <dl>
      <template v-if="false">
        ...
        <dd class="required">
          <label
            v-for="value of knittingTypes.filter((i) => !i.disabled)"
            :key="value.label"
          >
            <input
              type="radio"
              :value="value"
              v-model="knittingType"
      ...
      <template v-if="false">
        ...
        <dd class="disabled">
          <input
            type="range"
            v-model="fablicWeight2"
            :min="calcFablicWeight(fabricType.min! * kijihaba / 100)"
            :max="calcFablicWeight(fabricType.max! * kijihaba / 100)"
            :step="fablicWeihtStep"
            :disabled="true"
          />
      ...
      <table>
        ...
        <tr v-for="n of 3" :key="n">
          <template v-if="false">
            ...
            <td>
              <label
                v-for="label of fabricType.fiber1!.crossSections"
                :key="label"
              >
                <input
                  type="radio"
                  :value="label"
                  v-model="fiber1.crossSection"
                />
                {{ label }}
              </label>
            </td>
                ...
                <li v-for="label of fabricType.fiber1!.cutLengths" :key="label">
                  <label>
                    <input
                      type="radio"
                      :value="label"
                      v-model.number="fiber1.cutLength"
                    />
                    {{ label }}
                  </label>
                </li>
            ...
            <td>
              <input
                type="range"
                v-model="fiber1.sliverRatio"
                :min="fabricType.sliverRatioMin"
                :max="fabricType.sliverRatioMax"
                :step="sliverRatioStep"
              />
